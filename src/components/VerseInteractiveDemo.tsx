    ...
    <section id="versiculos" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 border-t border-[#E8DFD5] bg-[#F2EBE3]">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-6 text-xs text-[#6B533E]">
          ...
          <div className="flex flex-wrap gap-1 p-1 bg-[#FAF6F0] rounded-full border border-[#E8DFD5]">
            <button
              type="button"
        ...
        <div className="relative w-full max-w-lg mx-auto">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 w-full">
            <button
              ...
              className="w-full sm:w-auto min-h-[48px] px-5 py-2.5 rounded-xl bg-[#FAF6F0] hover:bg-[#FFFDF9] border border-[#E8DFD5] hover:border-[#C79801] text-[#2B1D12] font-bold text-sm shadow-xs hover:shadow-sm transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
            >
